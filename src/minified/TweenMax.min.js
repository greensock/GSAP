 ...
 **/
(window._gsQueue||(window._gsQueue=[])).push(function(){_gsDefine("TweenMax",["core.Animation","core.SimpleTimeline","TweenLite"],function(r,k,h){var q=function(g,d,a){h.call(this,g,d,a);this._cycle=0;this._yoyo=!0===this.vars.yoyo;this._repeat=this.vars.repeat||0;this._repeatDelay=this.vars.repeatDelay||0;this._dirty=!0},l=q.prototype=h.to({},0.1,{}),b=[];q.version=1.667;l.constructor=q;l.kill()._gc=!1;q.killTweensOf=q.killDelayedCallsTo=h.killTweensOf;q.getTweensOf=h.getTweensOf;q.ticker=h.ticker;
