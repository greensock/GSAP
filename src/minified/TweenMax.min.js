 ...
 **/
(window._gsQueue||(window._gsQueue=[])).push(function(){_gsDefine("TweenMax",["core.Animation","core.SimpleTimeline","TweenLite"],function(l,r,f){var n=function(j,d,a){f.call(this,j,d,a);this._cycle=0;this._yoyo=!0===this.vars.yoyo;this._repeat=this.vars.repeat||0;this._repeatDelay=this.vars.repeatDelay||0;this._dirty=!0},k=n.prototype=f.to({},0.1,{}),b=[];n.version=1.664;k.constructor=n;k.kill()._gc=!1;n.killTweensOf=n.killDelayedCallsTo=f.killTweensOf;n.getTweensOf=f.getTweensOf;n.ticker=f.ticker;
...
s&&(d||this._gc||this.vars.onRepeat&&this.vars.onRepeat.apply(this.vars.onRepeatScope||this,this.vars.onRepeatParams||b));E&&!this._gc&&(w&&(this._timeline.autoRemoveChildren&&this._enabled(!1,!1),this._active=!1),d||this.vars[E]&&this.vars[E].apply(this.vars[E+"Scope"]||this,this.vars[E+"Params"]||b))}};n.to=function(a,d,z){return new n(a,d,z)};n.from=function(a,d,z){z.runBackwards=!0;!1!==z.immediateRender&&(z.immediateRender=!0);return new n(a,d,z)};n.fromTo=function(a,d,z,g){g.startAt=z;z.immediateRender&&
(g.immediateRender=!0);return new n(a,d,g)};n.staggerTo=n.allTo=function(a,d,z,g,u,c,b){g=g||0;var s=[],E=a.length,t=z.delay||0,D,q,f;for(q=0;q<E;q++){D={};for(f in z)D[f]=z[f];D.delay=t;q===E-1&&u&&(D.onComplete=function(){z.onComplete&&z.onComplete.apply(z.onCompleteScope,z.onCompleteParams);u.apply(b,c)});s[q]=new n(a[q],d,D);t+=g}return s};n.staggerFrom=n.allFrom=function(a,d,z,g,u,c,b){z.runBackwards=!0;!1!==z.immediateRender&&(z.immediateRender=!0);return n.staggerTo(a,d,z,g,u,c,b)};n.staggerFromTo=
n.allFromTo=function(a,d,z,g,c,b,s,w){g.startAt=z;z.immediateRender&&(g.immediateRender=!0);return n.staggerTo(a,d,g,c,b,s,w)};n.delayedCall=function(a,d,c,g,u){return new n(d,0,{delay:a,onComplete:d,onCompleteParams:c,onCompleteScope:g,onReverseComplete:d,onReverseCompleteParams:c,onReverseCompleteScope:g,immediateRender:!1,useFrames:u,overwrite:0})};n.set=function(a,d){return new n(a,0,d)};n.isTweening=function(a){a=f.getTweensOf(a);for(var d=a.length,c;-1<--d;)if((c=a[d])._active||c._startTime===
c.timeline._time&&c.timeline._active)return!0;return!1};var s=function(a,d){for(var c=[],g=0,u=a._first;u;)u instanceof f?c[g++]=u:(d&&(c[g++]=u),c=c.concat(s(u,d)),g=c.length),u=u._next;return c},c=n.getAllTweens=function(a){return s(l._rootTimeline,a).concat(s(l._rootFramesTimeline,a))};n.killAll=function(a,d,z,g){null==d&&(d=!0);null==z&&(z=!0);var u=c(!1!=g),b=u.length;g=d&&z&&g;var s,w,E;for(E=0;E<b;E++)if(w=u[E],g||w instanceof r||(s=w.target===w.vars.onComplete)&&z||d&&!s)a?w.totalTime(w.totalDuration()):
w._enabled(!1,!1)};n.killChildTweensOf=function(a,d){if(null!=a)if(a.jquery)a.each(function(a,g){n.killChildTweensOf(g,d)});else{var c=f._tweenLookup,g=[],u,b;for(b in c)for(u=c[b].target.parentNode;u;)u===a&&(g=g.concat(c[b].tweens)),u=u.parentNode;u=g.length;for(c=0;c<u;c++)d&&g[c].totalTime(g[c].totalDuration()),g[c]._enabled(!1,!1)}};n.pauseAll=function(j,d,c){a(!0,j,d,c)};n.resumeAll=function(j,d,c){a(!1,j,d,c)};var a=function(a,d,b,g){void 0==d&&(d=!0);void 0==b&&(b=!0);var u=c(g);g=d&&b&&g;
...
this:this.duration((a-this._repeat*this._repeatDelay)/(this._repeat+1))};k.repeat=function(a){if(!arguments.length)return this._repeat;this._repeat=a;return this._uncache(!0)};k.repeatDelay=function(a){if(!arguments.length)return this._repeatDelay;this._repeatDelay=a;return this._uncache(!0)};k.yoyo=function(a){if(!arguments.length)return this._yoyo;this._yoyo=a;return this};return n},!0);_gsDefine("TimelineLite",["core.Animation","core.SimpleTimeline","TweenLite"],function(l,r,f){var n=function(a){r.call(this,
...
"onRepeatParams"],b=[],s=function(a){var j={},d;for(d in a)j[d]=a[d];return j},c=n.prototype=new r;n.version=1.641;c.constructor=n;c.kill()._gc=!1;c.to=function(a,j,d,c,g){return this.insert(new f(a,j,d),this._parseTimeOrLabel(g,c,!0))};c.from=function(a,j,d,c,g){return this.insert(f.from(a,j,d),this._parseTimeOrLabel(g,c,!0))};c.fromTo=function(a,j,d,c,g,u){return this.insert(f.fromTo(a,j,d,c),this._parseTimeOrLabel(u,g,!0))};c.staggerTo=function(a,j,d,c,g,u,b,k,w){b=new n({onComplete:b,onCompleteParams:k,
...
a,j,d),this._parseTimeOrLabel(g,c,!0))};c.set=function(a,j,d,c){j.immediateRender=!1;return this.insert(new f(a,0,j),this._parseTimeOrLabel(c,d,!0))};n.exportRoot=function(a,c){a=a||{};null==a.smoothChildTiming&&(a.smoothChildTiming=!0);var d=new n(a),b=d._timeline;null==c&&(c=!0);b._remove(d,!0);d._startTime=0;d._rawPrevTime=d._time=d._totalTime=b._time;for(var g=b._first,u;g;)u=g._next,(!c||!(g instanceof f&&g.target===g.vars.onComplete))&&d.insert(g,g._startTime-g._delay),g=u;b.insert(d,0);return d};
...
0,0,!0),s=a.length;for(c=0;c<s;c++){if((g=a[c])instanceof Array)g=new n({tweens:g});this.insert(g,u);"string"===typeof g||"function"===typeof g||("sequence"===d?u=g._startTime+g.totalDuration()/g._timeScale:"start"===d&&(g._startTime-=g.delay()));u+=b}return this._uncache(!0)};c.appendMultiple=function(a,c,d,b){return this.insertMultiple(a,this._parseTimeOrLabel(null,c,!0),d,b)};c.addLabel=function(a,c){this._labels[a]=c;return this};c.removeLabel=function(a){delete this._labels[a];return this};c.getLabelTime=
...
b));if(this._time>g)for(d=this._first;d;){E=d._next;if(this._paused&&!n)break;else if(d._active||d._startTime<=this._time&&!d._paused&&!d._gc)d._reversed?d.render((!d._dirty?d._totalDuration:d.totalDuration())-(a-d._startTime)*d._timeScale,c,!1):d.render((a-d._startTime)*d._timeScale,c,!1);d=E}else for(d=this._last;d;){E=d._prev;if(this._paused&&!n)break;else if(d._active||d._startTime<=g&&!d._paused&&!d._gc)d._reversed?d.render((!d._dirty?d._totalDuration:d.totalDuration())-(a-d._startTime)*d._timeScale,
...
c;this._dirty=!1}return this._totalDuration}0!==this.totalDuration()&&0!==a&&this.timeScale(this._totalDuration/a);return this};c.usesFrames=function(){for(var a=this._timeline;a._timeline;)a=a._timeline;return a===l._rootFramesTimeline};c.rawTime=function(){return this._paused||0!==this._totalTime&&this._totalTime!==this._totalDuration?this._totalTime:(this._timeline.rawTime()-this._startTime)*this._timeScale};return n},!0);_gsDefine("TimelineMax",["TimelineLite","TweenLite","easing.Ease"],function(l,
r,f){var n=function(b){l.call(this,b);this._repeat=this.vars.repeat||0;this._repeatDelay=this.vars.repeatDelay||0;this._cycle=0;this._yoyo=!0===this.vars.yoyo;this._dirty=!0},k=[],b=new f(null,null,1,0);f=n.prototype=new l;f.constructor=n;f.kill()._gc=!1;n.version=1.641;f.invalidate=function(){this._yoyo=!0===this.vars.yoyo;this._repeat=this.vars.repeat||0;this._repeatDelay=this.vars.repeatDelay||0;this._uncache(!0);return l.prototype.invalidate.call(this)};f.addCallback=function(b,c,a,j){return this.insert(r.delayedCall(0,
...
f=this._totalTime,g=this._startTime,u=this._timeScale,n=this._rawPrevTime,r=this._paused,w=this._cycle,E,t;if(b>=j){this._locked||(this._totalTime=j,this._cycle=this._repeat);if(!this._reversed&&!this._hasPausedChild()&&(E=!0,t="onComplete",0===this._duration&&(0===b||0>this._rawPrevTime)))this._rawPrevTime!==b&&(a=!0);this._rawPrevTime=b;this._yoyo&&0!==(this._cycle&1)?(this._time=0,b=-1E-6):(this._time=this._duration,b=this._duration+1E-6)}else if(0>=b){this._locked||(this._totalTime=this._cycle=
...
0===this._duration?n-1E-5:n;this._cycle=w;this._locked=!0;d=D?0:this._duration;this.render(d,c,0===this._duration);c||this._gc||this.vars.onRepeat&&this.vars.onRepeat.apply(this.vars.onRepeatScope||this,this.vars.onRepeatParams||k);q&&(d=D?this._duration+1E-6:-1E-6,this.render(d,!0,!1));this._time=x;this._totalTime=U;this._cycle=G;this._rawPrevTime=M;this._locked=!1}if(this._time===d&&!a)f!==this._totalTime&&this._onUpdate&&(c||this._onUpdate.apply(this.vars.onUpdateScope||this,this.vars.onUpdateParams||
...
f.repeatDelay=function(b){if(!arguments.length)return this._repeatDelay;this._repeatDelay=b;return this._uncache(!0)};f.yoyo=function(b){if(!arguments.length)return this._yoyo;this._yoyo=b;return this};f.currentLabel=function(b){return!arguments.length?this.getLabelBefore(this._time+1E-8):this.seek(b,!0)};return n},!0);_gsDefine("plugins.BezierPlugin",["plugins.TweenPlugin"],function(l){var r=function(){l.call(this,"bezier",-1);this._overwriteProps.pop();this._func={};this._round={}},f=r.prototype=
new l("bezier",1),n=180/Math.PI,k=Math.PI/180,b=[],s=[],c=[],a={},j=function(a,c,d,b){this.a=a;this.b=c;this.c=d;this.d=b;this.da=b-a;this.ca=d-a;this.ba=c-a},d=r.bezierThrough=function(d,u,f,n,w,E){var t={},D=[],q,k,G;w="string"===typeof w?","+w+",":",x,y,z,left,top,right,bottom,marginTop,marginLeft,marginRight,marginBottom,paddingLeft,paddingTop,paddingRight,paddingBottom,backgroundPosition,backgroundPosition_y,";null==u&&(u=1);for(k in d[0])D.push(k);b.length=s.length=c.length=0;for(q=D.length;-1<
--q;){k=D[q];a[k]=-1!==w.indexOf(","+k+",");G=t;var r=k,x;x=d;var h=k,B=a[k],v=E,A=[],C=void 0,y=void 0,l=void 0,e=void 0,p=void 0,C=void 0;if(v){x=[v].concat(x);for(y=x.length;-1<--y;)if("string"===typeof(C=x[y][h]))"="===C.charAt(1)&&(x[y][h]=v[h]+Number(C.charAt(0)+C.substr(2)))}C=x.length-2;if(0>C)A[0]=new j(x[0][h],0,0,x[-1>C?0:1][h]);else{for(y=0;y<C;y++)l=x[y][h],e=x[y+1][h],A[y]=new j(l,0,0,e),B&&(p=x[y+2][h],b[y]=(b[y]||0)+(e-l)*(e-l),s[y]=(s[y]||0)+(p-e)*(p-e));A[y]=new j(x[y][h],0,0,x[y+
1][h])}x=A;G[r]=x}for(q=b.length;-1<--q;)b[q]=Math.sqrt(b[q]),s[q]=Math.sqrt(s[q]);if(!n){for(q=D.length;-1<--q;)if(a[k]){d=t[D[q]];G=d.length-1;for(w=0;w<G;w++)E=d[w+1].da/s[w]+d[w].da/b[w],c[w]=(c[w]||0)+E*E}for(q=c.length;-1<--q;)c[q]=Math.sqrt(c[q])}for(q=D.length;-1<--q;){k=D[q];d=t[k];w=u;E=f;G=n;k=a[k];r=d.length-1;x=0;for(var h=d[0].a,m=p=e=v=C=e=l=C=y=l=A=v=B=void 0,B=0;B<r;B++)y=d[x],v=y.a,A=y.d,l=d[x+1].d,k?(e=b[B],p=s[B],m=0.25*(p+e)*w/(G?0.5:c[B]||0.5),C=A-(A-v)*(G?0.5*w:m/e),l=A+(l-
A)*(G?0.5*w:m/p),e=A-(C+(l-C)*(3*e/(e+p)+0.5)/4)):(C=A-0.5*(A-v)*w,l=A+0.5*(l-A)*w,e=A-(C+l)/2),C+=e,l+=e,y.c=C,y.b=0!==B?h:h=y.a+0.6*(y.c-y.a),y.da=A-v,y.ca=C-v,y.ba=h-v,E?(v=z(v,h,C,A),d.splice(x,1,v[0],v[1],v[2],v[3]),x+=4):x++,h=l;y=d[x];y.b=h;y.c=h+0.4*(y.d-h);y.da=y.d-y.a;y.ca=y.c-y.a;y.ba=h-y.a;E&&(v=z(y.a,h,y.c,y.d),d.splice(x,1,v[0],v[1],v[2],v[3]))}return t},z=r.cubicToQuadratic=function(a,c,d,b){var j={a:a},f={},t={},k={c:b},q=(a+c)/2,n=(c+d)/2;d=(d+b)/2;c=(q+n)/2;var n=(n+d)/2,r=(n-c)/
8;j.b=q+(a-q)/4;f.b=c+r;j.c=f.a=(j.b+f.b)/2;f.c=t.a=(c+n)/2;t.b=n-r;k.b=d+(b-d)/4;t.c=k.a=(t.b+k.b)/2;return[j,f,t,k]};r.quadraticToCubic=function(a,c,d){return new j(a,(2*c+a)/3,(2*c+d)/3,d)};f.constructor=r;r.API=2;r._cssRegister=function(){var a=window.com.greensock.plugins.CSSPlugin;if(a){var a=a._internals,c=a._parseToProxy,d=a._setPluginRatio,b=a.CSSPropTween;a._registerComplexSpecialProp("bezier",null,function(a,g,j,f,q,n){g instanceof Array&&(g={values:g});n=new r;j=g.values;var l=j.length-
1,s=[],x={},h,B,v;if(0>l)return q;for(h=0;h<=l;h++)v=c(a,j[h],f,q,n,l!==h),s[h]=v.end;for(B in g)x[B]=g[B];x.values=s;q=new b(a,"bezier",0,0,v.pt,2);q.data=v;q.plugin=n;q.setRatio=d;0===x.autoRotate&&(x.autoRotate=!0);x.autoRotate&&!(x.autoRotate instanceof Array)&&(h=!0===x.autoRotate?0:Number(x.autoRotate)*k,x.autoRotate=null!=v.end.left?[["left","top","rotation",h,!0]]:null!=v.end.x?[["x","y","rotation",h,!0]]:!1);x.autoRotate&&(f._transform||f._enableTransforms(!1),v.autoRotate=f._target._gsTransform);
n._onInitTween(v.proxy,x,f._tween);return q})}};f._onInitTween=function(a,c,b){this._target=a;c instanceof Array&&(c={values:c});this._props=[];this._timeRes=null==c.timeResolution?6:parseInt(c.timeResolution,10);var f=c.values||[],n={},k=f[0];b=c.autoRotate||b.vars.orientToBezier;var t,D,q;this._autoRotate=b?b instanceof Array?b:[["x","y","rotation",!0===b?0:Number(b)||0]]:null;for(t in k)this._props.push(t);for(k=this._props.length;-1<--k;)t=this._props[k],this._overwriteProps.push(t),b=this._func[t]=
"function"===typeof a[t],n[t]=!b?parseFloat(a[t]):a[t.indexOf("set")||"function"!==typeof a["get"+t.substr(3)]?t:"get"+t.substr(3)](),q||n[t]!==f[0][t]&&(q=n);if("cubic"!==c.type&&"quadratic"!==c.type&&"soft"!==c.type)n=d(f,isNaN(c.curviness)?1:c.curviness,!1,"thruBasic"===c.type,c.correlate,q);else{b=(b=c.type)||"soft";c={};q="cubic"===b?3:2;b="soft"===b;var k=[],l,r,s,x,h,B,v,A,C;b&&n&&(f=[n].concat(f));if(null==f||f.length<q+1)throw"invalid Bezier data";for(r in f[0])k.push(r);for(B=k.length;-1<
--B;){r=k[B];c[r]=h=[];C=0;A=f.length;for(v=0;v<A;v++)l=null==n?f[v][r]:"string"===typeof(s=f[v][r])&&"="===s.charAt(1)?n[r]+Number(s.charAt(0)+s.substr(2)):Number(s),b&&1<v&&v<A-1&&(h[C++]=(l+h[C-2])/2),h[C++]=l;A=C-q+1;for(v=C=0;v<A;v+=q)l=h[v],r=h[v+1],s=h[v+2],x=2===q?0:h[v+3],h[C++]=s=3===q?new j(l,r,s,x):new j(l,(2*r+l)/3,(2*r+s)/3,s);h.length=C}n=c}this._beziers=n;this._segCount=this._beziers[t].length;if(this._timeRes){k=this._beziers;t=this._timeRes;t=t>>0||6;n=[];r=[];f=s=0;c=t-1;q=[];b=
[];for(D in k){l=k[D];h=n;B=t;v=1/B;A=l.length;for(var y=void 0,z=void 0,e=x=C=z=void 0,p=y=void 0,m=void 0,m=e=void 0;-1<--A;){e=l[A];z=e.a;C=e.d-z;x=e.c-z;e=e.b-z;z=0;for(p=1;p<=B;p++)y=v*p,m=1-y,y=z-(z=(y*y*C+3*m*(y*x+m*e))*y),m=A*B+p-1,h[m]=(h[m]||0)+y*y}}k=n.length;for(D=0;D<k;D++)s+=Math.sqrt(n[D]),l=D%t,b[l]=s,l===c&&(f+=s,l=D/t>>0,q[l]=b,r[l]=f,s=0,b=[]);this._length=f;this._lengths=r;this._segments=q;this._l1=this._li=this._s1=this._si=0;this._l2=this._lengths[0];this._curSeg=this._segments[0];
...
a;);0===j&&a<this._s1?this._s1=0:j++;this._s2=l[j];this._si=j}l=(j+(a-this._s1)/(this._s2-this._s1))*this._prec}else f=0>a?0:1<=a?c-1:c*a>>0,l=(a-f*(1/c))*c;c=1-l;for(j=this._props.length;-1<--j;)if(a=this._props[j],k=this._beziers[a][f],q=(l*l*k.da+3*c*(l*k.ca+c*k.ba))*l+k.a,this._round[a]&&(q=q+(0<q?0.5:-0.5)>>0),b[a])d[a](q);else d[a]=q;if(this._autoRotate){var c=this._autoRotate,r,s,z,x,h;for(j=c.length;-1<--j;)a=c[j][2],x=c[j][3]||0,h=!0===c[j][4]?1:n,k=this._beziers[c[j][0]][f],q=this._beziers[c[j][1]][f],
...
y,V,e,p,m,H,F,I=C.indexOf("Android"),J=h.createElement("div");m=(e=-1!==C.indexOf("Safari")&&-1===C.indexOf("Chrome")&&(-1===I||3<Number(C.substr(I+8,1))))&&6>Number(C.substr(C.indexOf("Version/")+8,1));p=-1!==C.indexOf("Firefox");/MSIE ([0-9]{1,}[\.0-9]{0,})/.exec(C);H=parseFloat(RegExp.$1);J.innerHTML="<a style='top:1px;opacity:.55;'>a</a>";F=(C=J.getElementsByTagName("a")[0])?/^0.55/.test(C.style.opacity):!1;var S=function(a){return u.test("string"===typeof a?a:(a.currentStyle?a.currentStyle.filter:
...
b.rotation=a.rotation*M;b.skewX=a.skewX*M;b.scaleX=a.scaleX;b.scaleY=a.scaleY;b.x=a.x;b.y=a.y;W&&(b.z=a.z,b.rotationX=a.rotationX*M,b.rotationY=a.rotationY*M,b.scaleZ=a.scaleZ);b.filters&&delete b.filters;return b},ma=function(a,e,c,b){var d={};a=a.style;var h,K,m;for(K in c)if("cssText"!==K&&"length"!==K&&isNaN(K)&&e[K]!==(h=c[K]))if(-1===K.indexOf("Origin")&&("number"===typeof h||"string"===typeof h))d[K]=(""===h||"auto"===h||"none"===h)&&"string"===typeof e[K]&&""!==e[K].replace(z,"")?0:h,void 0!==
a[K]&&(m=new ha(a,K,a[K],m));if(b)for(K in b)"className"!==K&&(d[K]=b[K]);return{difs:d,firstMPT:m}},sa={width:["Left","Right"],height:["Top","Bottom"]},ta=["marginLeft","marginRight","marginTop","marginBottom"],T=function(a,e,c,b,d){if("px"===b||!b)return c;if("auto"===b||!c)return 0;var m=D.test(e),K=a,p=B.style,j=0>c;j&&(c=-c);"%"===b&&-1!==e.indexOf("border")?m=c/100*(m?a.clientWidth:a.clientHeight):(p.cssText="border-style:solid; border-width:0; position:absolute; line-height:0;","%"===b||"em"===
b||!K.appendChild?(K=a.parentNode||h.body,p[m?"width":"height"]=c+b):p[m?"borderLeftWidth":"borderTopWidth"]=c+b,K.appendChild(B),m=parseFloat(B[m?"offsetWidth":"offsetHeight"]),K.removeChild(B),0===m&&!d&&(m=T(a,e,c,b,!0)));return j?-m:m},ia=function(a,e){if(null==a||""===a||"auto"===a||"auto auto"===a)a="0 0";var c=a.split(" "),b=-1!==a.indexOf("left")?"0%":-1!==a.indexOf("right")?"100%":c[0],d=-1!==a.indexOf("top")?"0%":-1!==a.indexOf("bottom")?"100%":c[1];null==d?d="0":"center"===d&&(d="50%");
if("center"===b||isNaN(parseFloat(b)))b="50%";e&&(e.oxp=-1!==b.indexOf("%"),e.oyp=-1!==d.indexOf("%"),e.oxr="="===b.charAt(1),e.oyr="="===d.charAt(1),e.ox=parseFloat(b.replace(z,"")),e.oy=parseFloat(d.replace(z,"")));return b+" "+d+(2<c.length?" "+c[2]:"")},na=function(a,e){return"string"===typeof a&&"="===a.charAt(1)?parseInt(a.charAt(0)+"1",10)*parseFloat(a.substr(2)):parseFloat(a)-parseFloat(e)},X=function(a,e){return null==a?e:"string"===typeof a&&"="===a.charAt(1)?parseInt(a.charAt(0)+"1",10)*
...
Number(e[2]);3<e.length&&(e[3]=Number(e[3]));return e},Y="(?:\\b(?:(?:rgb|rgba)\\(.+?\\))|\\B#.+?\\b";for(c in aa)Y+="|"+c+"\\b";var Y=RegExp(Y+")","gi"),oa=function(e,c,b){if(null==e)return function(a){return a};var h=c?(e.match(Y)||[""])[0]:"",m=e.split(h).join("").match(d)||[],p=e.substr(0,e.indexOf(m[0])),K=")"===e.charAt(e.length-1)?")":"",j=-1!==e.indexOf(" ")?" ":",",f=m.length,g=0<f?m[0].replace(a,""):"";return c?function(a){"number"===typeof a&&(a+=g);var e=(a.match(Y)||[h])[0];a=a.split(e).join("").match(d)||
[];var c=a.length;if(f>c--)for(;++c<f;)a[c]=b?a[(c-1)/2>>0]:m[c];return p+a.join(j)+j+e+K}:function(a){"number"===typeof a&&(a+=g);a=a.match(d)||[];var e=a.length;if(f>e--)for(;++e<f;)a[e]=b?a[(e-1)/2>>0]:m[e];return p+a.join(j)+K}},C=function(a){a=a.split(",");return function(e,c,b,d,h,m,p){c=(c+"").split(" ");p={};for(b=0;4>b;b++)p[a[b]]=c[b]=c[b]||c[(b-1)/2>>0];return d.parse(e,p,h,m)}};A._setPluginRatio=function(a){this.plugin.setRatio(a);for(var e=this.data,c=e.proxy,b=e.firstMPT,d;b;)d=c[b.v],
b.r?d=0<d?d+0.5>>0:d-0.5>>0:1E-6>d&&-1E-6<d&&(d=0),b.t[b.p]=d,b=b._next;e.autoRotate&&(e.autoRotate.rotation=c.rotation);if(1===a)for(b=e.firstMPT;b;){a=b.t;if(a.type){if(1===a.type){c=a.xs0+a.s+a.xs1;for(e=1;e<a.l;e++)c+=a["xn"+e]+a["xs"+(e+1)];a.e=c}}else a.e=a.s+a.xs0;b=b._next}};var ha=function(a,e,c,b,d){this.t=a;this.p=e;this.v=c;this.r=d;b&&(b._prev=this,this._next=b)};A._parseToProxy=function(a,e,c,b,d,h){var m=b,p={},j={},f=c._transform,g=x,k;c._transform=null;x=e;b=a=c.parse(a,e,b,d);x=
g;h&&(c._transform=f,m&&(m._prev=null,m._prev&&(m._prev._next=null)));for(;b&&b!==m;){if(1>=b.type&&(f=b.p,j[f]=b.s+b.c,p[f]=b.s,h||(k=new ha(b,"s",f,k,b.r),b.c=0),1===b.type))for(c=b.l;0<--c;)g="xn"+c,f=b.p+"_"+g,j[f]=b.data[g],p[f]=b[g],h||(k=new ha(b,g,f,k,b.rxp[g]));b=b._next}return{proxy:p,end:j,firstMPT:k,pt:a}};var O=A.CSSPropTween=function(a,e,c,d,h,m,p,j,g,k,n){this.t=a;this.p=e;this.s=c;this.c=d;this.n=p||"css_"+e;a instanceof O||b.push(this.n);this.r=j;this.type=m||0;g&&(this.pr=g,f=!0);
this.b=void 0===k?c:k;this.e=void 0===n?c+d:n;h&&(this._next=h,h._prev=this)},fa=r.parseComplex=function(e,c,b,d,h,m,p,f,g,k){p=new O(e,c,0,0,p,k?2:1,null,!1,f,b,d);e=b.split(", ").join(",").split(" ");c=(d+"").split(", ").join(",").split(" ");b=e.length;f=!1!==y;var n,l,H,q,s;b!==c.length&&(e=(m||"").split(" "),b=e.length);p.plugin=g;p.setRatio=k;for(m=0;m<b;m++)if(g=e[m],n=c[m],(k=parseFloat(g))||0===k)p.appendXtra("",k,na(n,k),n.replace(j,""),f&&-1!==n.indexOf("px"),!0);else if(h&&("#"===g.charAt(0)||
0===g.indexOf("rgb")||aa[g]))g=ka(g),n=ka(n),(k=6<g.length+n.length)&&!F&&0===n[3]?(p["xs"+p.l]+=p.l?" transparent":"transparent",p.e=p.e.split(c[m]).join("transparent")):(p.appendXtra(k?"rgba(":"rgb(",g[0],n[0]-g[0],",",!0,!0).appendXtra("",g[1],n[1]-g[1],",",!0).appendXtra("",g[2],n[2]-g[2],k?",":")",!0),k&&(g=4>g.length?1:g[3],p.appendXtra("",g,(4>n.length?1:n[3])-g,")",!1)));else if(k=g.match(a)){H=n.match(j);if(!H||H.length!==k.length)return p;for(n=l=0;n<k.length;n++)s=k[n],q=g.indexOf(s,l),
p.appendXtra(g.substr(l,q-l),Number(s),na(H[n],s),"",f&&"px"===g.substr(q+s.length,2),0===n),l=q+s.length;p["xs"+p.l]+=g.substr(l)}else p["xs"+p.l]+=p.l?" "+g:g;if(-1!==d.indexOf("=")&&p.data){d=p.xs0+p.data.s;for(m=1;m<p.l;m++)d+=p["xs"+m]+p.data["xn"+m];p.e=d+p["xs"+m]}p.l||(p.type=-1,p.xs0=p.e);return p.xfirst||p},P=9,c=O.prototype;for(c.l=c.pr=0;0<--P;)c["xn"+P]=0,c["xs"+P]="";c.xs0="";c._next=c._prev=c.xfirst=c.data=c.plugin=c.setRatio=c.rxp=null;c.appendXtra=function(a,e,c,b,d,h){var p=this.l;
this["xs"+p]+=h&&p?" "+a:a||"";if(!c&&0!==p&&!this.plugin)return this["xs"+p]+=e+(b||""),this;this.l++;this.type=this.setRatio?2:1;this["xs"+this.l]=b||"";if(0<p)return this.data["xn"+p]=e+c,this.rxp["xn"+p]=d,this["xn"+p]=e,this.plugin||(this.xfirst=new O(this,"xn"+p,e,c,this.xfirst||this,0,this.n,d,this.pr),this.xfirst.xs0=0),this;this.data={s:e+c};this.rxp={};this.s=e;this.c=c;this.r=d;return this};var pa=function(a,e,c,b,d,p,h){this.p=b?ba(a)||a:a;s[a]=s[this.p]=this;this.format=p||oa(e,d);c&&
(this.parse=c);this.clrs=d;this.dflt=e;this.pr=h||0},L=A._registerComplexSpecialProp=function(a,e,c,b,d,p,h){a=a.split(",");e=e instanceof Array?e:[e];for(var m=a.length;-1<--m;)new pa(a[m],e[m],c,b&&0===m,d,p,h)},A=function(a){if(!s[a]){var e=a.charAt(0).toUpperCase()+a.substr(1)+"Plugin";L(a,null,function(a,c,b,d,p,h,m){var g=window.com.greensock.plugins[e];if(!g)return window.console&&console.log("Error: "+e+" js file not loaded."),p;g._cssRegister();return s[b].parse(a,c,b,d,p,h,m)})}},c=pa.prototype;
c.parseComplex=function(a,e,c,b,d,p){return fa(a,this.p,e,c,this.clrs,this.dflt,b,this.pr,d,p)};c.parse=function(a,e,c,b,d,p){return this.parseComplex(a.style,this.format(N(a,c,k,!1,this.dflt)),this.format(e),d,p)};r.registerSpecialProp=function(a,e,c){L(a,null,function(a,b,d,p,h,m){h=new O(a,d,0,0,h,2,d,!1,c);h.plugin=m;h.setRatio=e(a,b,p._tween,d);return h},!1,!1,null,c)};var qa="scaleX scaleY scaleZ x y z skewX rotation rotationX rotationY perspective".split(" "),Q=ba("transform"),ua=la+"transform",
ra=ba("transformOrigin"),W=null!==ba("perspective"),da=function(a,e,c){var b=c?a._gsTransform||{skewY:0}:{skewY:0},d=0>b.scaleX,p=W?parseFloat(N(a,ra,e,!1,"0 0 0").split(" ")[2])||b.zOrigin||0:0,h,m,g,j,f,k,n,l;Q?h=N(a,ua,e,!0):a.currentStyle&&(h=(h=a.currentStyle.filter.match(q))&&4===h.length?h[0].substr(4)+","+Number(h[2].substr(4))+","+Number(h[1].substr(4))+","+h[3].substr(4)+","+(b?b.x:0)+","+(b?b.y:0):null);m=(h||"").match(/(?:\-|\b)[\d\-\.e]+\b/gi)||[];for(e=m.length;-1<--e;)h=Number(m[e]),
m[e]=(1E5*h+(0>h?-0.5:0.5)>>0)/1E5;if(16===m.length){if(d=m[8],h=m[9],f=m[10],k=m[12],n=m[13],l=m[14],b.zOrigin&&(l=-b.zOrigin,k=d*l-m[12],n=h*l-m[13],l=f*l+b.zOrigin-m[14]),!c||k!==b.x||n!==b.y||l!==b.z){var H=m[0],s=m[1],F=m[2],u=m[3],t=m[4],I=m[5],v=m[6],S=m[7];m=m[11];var y=-Math.PI+1E-4,w=Math.PI-1E-4,J=b.rotationX=Math.atan2(v,f),C=J<y||J>w,x,z,B,A;J&&(B=Math.cos(-J),A=Math.sin(-J),J=t*B+d*A,x=I*B+h*A,z=v*B+f*A,d=t*-A+d*B,h=I*-A+h*B,f=v*-A+f*B,m=S*-A+m*B,t=J,I=x,v=z);if(J=b.rotationY=Math.atan2(d,
...
n;b.z=l}}else if(!W||0===m.length||b.x!==m[4]||b.y!==m[5]||!b.rotationX&&!b.rotationY){h=(g=6<=m.length)?m[0]:1;k=m[1]||0;f=m[2]||0;n=g?m[3]:1;b.x=m[4]||0;b.y=m[5]||0;g=Math.sqrt(h*h+k*k);j=Math.sqrt(n*n+f*f);h=h||k?Math.atan2(k,h):b.rotation||0;f=f||n?Math.atan2(f,n)+h:b.skewX||0;k=g-Math.abs(b.scaleX||0);n=j-Math.abs(b.scaleY||0);Math.abs(f)>Math.PI/2&&Math.abs(f)<1.5*Math.PI&&(d?(g*=-1,f+=0>=h?Math.PI:-Math.PI,h+=0>=h?Math.PI:-Math.PI):(j*=-1,f+=0>=f?Math.PI:-Math.PI));d=(h-b.rotation)%Math.PI;
l=(f-b.skewX)%Math.PI;if(void 0===b.skewX||1E-6<k||-1E-6>k||1E-6<n||-1E-6>n||1E-6<d||-1E-6>d||1E-6<l||-1E-6>l)b.scaleX=g,b.scaleY=j,b.rotation=h,b.skewX=f;W&&(b.rotationX=b.rotationY=b.z=0,b.perspective=parseFloat(r.defaultTransformPerspective)||0,b.scaleZ=1)}b.zOrigin=p;for(e in b)1E-6>b[e]&&-1E-6<b[e]&&(b[e]=0);c&&(a._gsTransform=b);return b},va=function(a){var e=this.data,b=-e.rotation,c=b+e.skewX,d=(1E5*Math.cos(b)*e.scaleX>>0)/1E5,b=(1E5*Math.sin(b)*e.scaleX>>0)/1E5,h=(1E5*Math.sin(c)*-e.scaleY>>
0)/1E5,c=(1E5*Math.cos(c)*e.scaleY>>0)/1E5,m=this.t.style,p=this.t.currentStyle,f,j;if(p){j=b;b=-h;h=-j;f=p.filter;m.filter="";var k=this.t.offsetWidth;j=this.t.offsetHeight;var n="absolute"!==p.position,l="progid:DXImageTransform.Microsoft.Matrix(M11="+d+", M12="+b+", M21="+h+", M22="+c,q=e.x,s=e.y,F,I;null!=e.ox&&(F=(e.oxp?0.01*k*e.ox:e.ox)-k/2,I=(e.oyp?0.01*j*e.oy:e.oy)-j/2,q+=F-(F*d+I*b),s+=I-(F*h+I*c));if(n)F=k/2,I=j/2,l+=", Dx="+(F-(F*d+I*b)+q)+", Dy="+(I-(F*h+I*c)+s)+")";else{var r=8>H?1:-1;
F=e.ieOffsetX||0;I=e.ieOffsetY||0;e.ieOffsetX=Math.round((k-((0>d?-d:d)*k+(0>b?-b:b)*j))/2+q);e.ieOffsetY=Math.round((j-((0>c?-c:c)*j+(0>h?-h:h)*k))/2+s);for(P=0;4>P;P++)k=ta[P],j=p[k],j=-1!==j.indexOf("px")?parseFloat(j):T(this.t,k,parseFloat(j),j.replace(g,""))||0,q=j!==e[k]?2>P?-e.ieOffsetX:-e.ieOffsetY:2>P?F-e.ieOffsetX:I-e.ieOffsetY,m[k]=(e[k]=Math.round(j-q*(0===P||2===P?1:r)))+"px";l+=", sizingMethod='auto expand')"}m.filter=-1!==f.indexOf("DXImageTransform.Microsoft.Matrix(")?f.replace(U,
l):l+" "+f;if(0===a||1===a)if(1===d&&0===b&&0===h&&1===c&&(!n||-1!==l.indexOf("Dx=0, Dy=0")))(!u.test(f)||100===parseFloat(RegExp.$1))&&-1===f.indexOf("gradient(")&&m.removeAttribute("filter")}},wa=function(){var a=this.data,e=this.t.style,b=a.perspective,c=a.scaleX,d=0,h=0,m=0,j=0,f=a.scaleY,g=0,k=0,n=0,l=0,H=a.scaleZ,q=0,s=0,F=0,I=b?-1/b:0,r=a.rotation,u=a.zOrigin,t,v,J,B,S;p&&(v=e.top+"",t=parseFloat(v)||0,v=v.substr((t+"").length),a._ffFix=!a._ffFix,e.top=(a._ffFix?t+0.05:t-0.05)+(""===v?"px":
v));r&&(t=Math.cos(r),r=Math.sin(r),J=f*r,d=c*-r,f*=t,c*=t,j=J);if(r=a.rotationY)t=Math.cos(r),r=Math.sin(r),B=H*-r,S=I*-r,h=c*r,g=j*r,H*=t,I*=t,c*=t,j*=t,n=B,s=S;if(r=a.rotationX)t=Math.cos(r),r=Math.sin(r),v=d*t+h*r,J=f*t+g*r,B=l*t+H*r,S=F*t+I*r,h=d*-r+h*t,g=f*-r+g*t,H=l*-r+H*t,I=F*-r+I*t,d=v,f=J,l=B,F=S;u&&(q-=u,m=h*q,k=g*q,q=H*q+u);m+=a.x;k+=a.y;q=(1E5*(q+a.z)>>0)/1E5;e[Q]="matrix3d("+(1E5*c>>0)/1E5+","+(1E5*j>>0)/1E5+","+(1E5*n>>0)/1E5+","+(1E5*s>>0)/1E5+","+(1E5*d>>0)/1E5+","+(1E5*f>>0)/1E5+
...
"matrix("+c+","+e+","+d+","+b+","+a.x+","+a.y+")"}};L("transform,scale,scaleX,scaleY,scaleZ,x,y,z,rotation,rotationX,rotationY,rotationZ,skewX,skewY,shortRotation,shortRotationX,shortRotationY,shortRotationZ,transformOrigin,transformPerspective",null,function(a,e,b,c,d,h,m){if(c._transform)return d;e=c._transform=da(a,k,!0);var p=a.style,j=qa.length,f,g,n,l,q;if("string"===typeof m.transform&&Q)g=p[Q],p[Q]=m.transform,f=da(a,null,!1),p[Q]=g;else if("object"===typeof m){g=null!=m.rotation?m.rotation:
null!=m.rotationZ?m.rotationZ:e.rotation*M;f={scaleX:X(null!=m.scaleX?m.scaleX:m.scale,e.scaleX),scaleY:X(null!=m.scaleY?m.scaleY:m.scale,e.scaleY),scaleZ:X(null!=m.scaleZ?m.scaleZ:m.scale,e.scaleZ),x:X(m.x,e.x),y:X(m.y,e.y),z:X(m.z,e.z),perspective:X(m.transformPerspective,e.perspective)};f.rotation=null!=m.shortRotation||null!=m.shortRotationZ?ja(m.shortRotation||m.shortRotationZ||0,e.rotation):"number"===typeof g?g*G:$(g,e.rotation);W&&(f.rotationX=null!=m.shortRotationX?ja(m.shortRotationX,e.rotationX):
...
g,f.rotation+=g;1E-6>f.skewY&&-1E-6<f.skewY&&(f.skewY=0);1E-6>f.skewX&&-1E-6<f.skewX&&(f.skewX=0);1E-6>f.rotation&&-1E-6<f.rotation&&(f.rotation=0)}l=e.z||e.rotationX||e.rotationY||f.z||f.rotationX||f.rotationY||f.perspective;!l&&null!=f.scale&&(f.scaleZ=1);for(;-1<--j;)if(b=qa[j],n=f[b]-e[b],1E-6<n||-1E-6>n||null!=x[b])q=!0,d=new O(e,b,e[b],n,d),d.xs0=0,d.plugin=h,c._overwriteProps.push(d.n);if((n=m.transformOrigin)||W&&l&&e.zOrigin)Q?(q=!0,n=(n||N(a,b,k,!1,"50% 50%"))+"",b=ra,d=new O(p,b,0,0,d,
-1,"css_transformOrigin"),d.b=p[b],d.plugin=h,W?(g=e.zOrigin,n=n.split(" "),e.zOrigin=(2<n.length?parseFloat(n[2]):g)||0,d.xs0=d.e=p[b]=n[0]+" "+(n[1]||"50%")+" 0px",d=new O(e,"zOrigin",0,0,d,-1,d.n),d.b=g,d.xs0=d.e=e.zOrigin):d.xs0=d.e=p[b]=n):ia(n+"",e);q&&(c._transformType=l||3===this._transformType?3:2);return d},!0);L("boxShadow","0px 0px 0px 0px #999",null,!0,!0);L("borderRadius","0px",function(a,e,b,c,d){e=this.format(e);c=["borderTopLeftRadius","borderTopRightRadius","borderBottomRightRadius",
"borderBottomLeftRadius"];var m=a.style,h,p,f,g,j,l,q,H,r,F,s,t;H=parseFloat(a.offsetWidth);r=parseFloat(a.offsetHeight);e=e.split(" ");for(h=0;h<c.length;h++)this.p.indexOf("border")&&(c[h]=ba(c[h])),g=f=N(a,c[h],k,!1,"0px"),-1!==g.indexOf(" ")&&(f=g.split(" "),g=f[0],f=f[1]),j=p=e[h],l=parseFloat(g),s=g.substr((l+"").length),(t="="===j.charAt(1))?(q=parseInt(j.charAt(0)+"1",10),j=j.substr(2),q*=parseFloat(j),F=j.substr((q+"").length-(0>q?1:0))||""):(q=parseFloat(j),F=j.substr((q+"").length)),""===
F&&(F=n[b]||s),F!==s&&(g=T(a,"borderLeft",l,s),l=T(a,"borderTop",l,s),"%"===F?(g=100*(g/H)+"%",f=100*(l/r)+"%"):"em"===F?(s=T(a,"borderLeft",1,"em"),g=g/s+"em",f=l/s+"em"):(g+="px",f=l+"px"),t&&(j=parseFloat(g)+q+F,p=parseFloat(f)+q+F)),d=fa(m,c[h],g+" "+f,j+" "+p,!1,"0px",d);return d},!0,!1,oa("0px 0px 0px 0px",!1,!0));L("backgroundPosition","0 0",function(a,e,b,c,d,m){b=k||ca(a,null);b=this.format((b?H?b.getPropertyValue("background-position-x")+" "+b.getPropertyValue("background-position-y"):b.getPropertyValue("background-position"):
a.currentStyle.backgroundPositionX+" "+a.currentStyle.backgroundPositionY)||"0 0");e=this.format(e);var h,p,f,g;if(-1!==b.indexOf("%")!==(-1!==e.indexOf("%"))){c=b.split(" ");h=e.split(" ");v.setAttribute("src",N(a,"backgroundImage").replace(E,""));for(p=2;-1<--p;)b=c[p],f=-1!==b.indexOf("%"),f!==(-1!==h[p].indexOf("%"))&&(g=0===p?a.offsetWidth-v.width:a.offsetHeight-v.height,c[p]=f?parseFloat(b)/100*g+"px":100*(parseFloat(b)/g)+"%");b=c.join(" ")}return this.parseComplex(a.style,b,e,d,m)},!1,!1,
ia);L("backgroundSize","0 0",null,!1,!1,ia);L("perspective","0px",null,!0);L("perspectiveOrigin","50% 50%",null,!0);L("transformStyle","preserve-3d",null,!0);L("backfaceVisibility","visible",null,!0);L("margin",null,C("marginTop,marginRight,marginBottom,marginLeft"));L("padding",null,C("paddingTop,paddingRight,paddingBottom,paddingLeft"));L("clip","rect(0px,0px,0px,0px)");L("textShadow","0px 0px 0px #999",null,!1,!0);L("autoRound",null,function(a,e,b,c,d){return d});L("border","0px solid #000",function(a,
e,b,c,d,m){return this.parseComplex(a.style,this.format(N(a,"borderTopWidth",k,!1,"0px")+" "+N(a,"borderTopStyle",k,!1,"solid")+" "+N(a,"borderTopColor",k,!1,"#000")),this.format(e),d,m)},!1,!0,function(a){var e=a.split(" ");return e[0]+" "+(e[1]||"solid")+" "+(a.match(Y)||["#000"])[0]});var ya=function(a){var e=this.t;a=this.s+this.c*a;var b;100===a&&(e.removeAttribute("filter"),b=!N(this.data,"filter"));b||(this.xn1&&(e.filter=e.filter||"alpha(opacity=100)"),e.filter=-1===e.filter.indexOf("opacity")?
e.filter+(" alpha(opacity="+(a>>0)+")"):e.filter.replace(u,"opacity="+(a>>0)))};L("opacity,alpha,autoAlpha","1",function(a,e,b,c,d,m){var h=parseFloat(N(a,"opacity",k,!1,"1"));e=parseFloat(e);var p=a.style,f;"autoAlpha"===b&&(f=N(a,"visibility",k),1===h&&"hidden"===f&&(h=0),d=new O(p,"visibility",0,0,d,-1,null,!1,0,0!==h?"visible":"hidden",0===e?"hidden":"visible"),d.xs0="visible",c._overwriteProps.push(d.n));F?d=new O(p,"opacity",h,e-h,d):(d=new O(p,"opacity",100*h,100*(e-h),d),d.xn1="autoAlpha"===
b?1:0,p.zoom=1,d.type=2,d.b="alpha(opacity="+d.s+")",d.e="alpha(opacity="+(d.s+d.c)+")",d.data=a,d.plugin=m,d.setRatio=ya);return d});var za=function(a){if(1===a||0===a){this.t.className=1===a?this.e:this.b;a=this.data;for(var e=this.t.style,b=e.removeProperty?"removeProperty":"removeAttribute";a;){if(a.v)e[a.p]=a.v;else e[b](a.p.replace(R,"-$1").toLowerCase());a=a._next}}else this.t.className!==this.b&&(this.t.className=this.b)};L("className",null,function(a,e,b,c,d,m,h){var p=a.className,f=a.style.cssText;
d=c._classNamePT=new O(a,b,0,0,d,2);d.setRatio=za;d.b=p;d.e="="!==e.charAt(1)?e:"+"===e.charAt(0)?p+" "+e.substr(2):p.split(e.substr(2)).join("");c._tween._duration&&(e=ea(a,k,!0),a.className=d.e,h=ma(a,e,ea(a),h),a.className=p,d.data=h.firstMPT,a.style.cssText=f,d=d.xfirst=c.parse(a,h.difs,d,m));return d});c=["bezier","throwProps","physicsProps","physics2D"];for(P=c.length;P--;)A(c[P]);c=r.prototype;c._firstPT=null;c._onInitTween=function(a,c,d){if(!a.nodeType)return!1;this._target=a;this._tween=
d;this._vars=c;y=c.autoRound;f=!1;n=c.suffixMap||r.suffixMap;k=ca(a,"");b=this._overwriteProps;d=a.style;var h,p,g,j;if(V&&""===d.zIndex&&(h=N(a,"zIndex",k),"auto"===h||""===h))d.zIndex=0;"string"===typeof c&&(p=d.cssText,h=ea(a,k),d.cssText=p+";"+c,h=ma(a,h,ea(a)).difs,!F&&Z.test(c)&&(h.opacity=parseFloat(RegExp.$1)),c=h,d.cssText=p);this._firstPT=c=this.parse(a,c,null);if(this._transformType){h=3===this._transformType;if(Q){if(e){V=!0;if(""===d.zIndex&&(j=N(a,"zIndex",k),"auto"===j||""===j))d.zIndex=
0;m&&(d.WebkitBackfaceVisibility=this._vars.WebkitBackfaceVisibility||(h?"visible":"hidden"))}}else d.zoom=1;for(d=c;d&&d._next;)d=d._next;j=new O(a,"transform",0,0,null,2);this._linkCSSP(j,null,d);j.setRatio=h&&W?wa:Q?xa:va;j.data=this._transform||da(a,k,!0);b.pop()}if(f){for(;c;){a=c._next;for(d=p;d&&d.pr>c.pr;)d=d._next;(c._prev=d?d._prev:g)?c._prev._next=c:p=c;(c._next=d)?d._prev=c:g=c;c=a}this._firstPT=p}return!0};c.parse=function(a,e,b,c){var d=a.style,m,h,p,f,g,j,l,q;for(m in e){g=e[m];if(h=
s[m])b=h.parse(a,g,m,this,b,c,e);else if(h=N(a,m,k)+"",l="string"===typeof g,"color"===m||"fill"===m||"stroke"===m||-1!==m.indexOf("Color")||l&&!g.indexOf("rgb"))l||(g=ka(g),g=(3<g.length?"rgba(":"rgb(")+g.join(",")+")"),b=fa(d,m,h,g,!0,"transparent",b,0,c);else if(l&&(-1!==g.indexOf(" ")||-1!==g.indexOf(",")))b=fa(d,m,h,g,!0,null,b,0,c);else{p=parseFloat(h);j=h.substr((p+"").length);if(""===h||"auto"===h)if("width"===m||"height"===m){p=a;q=m;f=k;j=parseFloat("width"===q?p.offsetWidth:p.offsetHeight);
q=sa[q];var H=q.length;for(f=f||ca(p,null);-1<--H;)j-=parseFloat(N(p,"padding"+q[H],f,!0))||0,j-=parseFloat(N(p,"border"+q[H]+"Width",f,!0))||0;p=j;j="px"}else p="opacity"!==m?0:1,j="";(q=l&&"="===g.charAt(1))?(f=parseInt(g.charAt(0)+"1",10),g=g.substr(2),f*=parseFloat(g),l=g.substr((f+"").length-(0>f?1:0))||""):(f=parseFloat(g),l=l?g.substr((f+"").length)||"":"");""===l&&(l=n[m]||j);g=f||0===f?(q?f+p:f)+l:e[m];if(j!==l&&""!==l&&(f||0===f))if(p||0===p)if(p=T(a,m,p,j),"%"===l?(p/=T(a,m,100,"%")/100,
100<p&&(p=100)):"em"===l?p/=T(a,m,1,"em"):(f=T(a,m,f,l),l="px"),q&&(f||0===f))g=f+p+l;q&&(f+=p);(p||0===p)&&(f||0===f)?(b=new O(d,m,p,f-p,b,0,"css_"+m,!1!==y&&("px"===l||"zIndex"===m),0,h,g),b.xs0=l):!g&&("NaN"===g+""||null==g)?window.console&&console.log("invalid "+m+" tween value. "):(b=new O(d,m,f||p||0,0,b,-1,"css_"+m,!1,0,h,g),b.xs0="display"===m&&"none"===g?h:g)}c&&(b&&!b.plugin)&&(b.plugin=c)}return b};c.setRatio=function(a){var e=this._firstPT,b,c;if(1===a&&(this._tween._time===this._tween._duration||
...
this._linkCSSP(c,this._target._gsOverwrittenClassNamePT),this._classNamePT=null,b=!0;return l.prototype._kill.call(this,a)||b};l.activate([r]);return r},!0);_gsDefine("plugins.RoundPropsPlugin",["plugins.TweenPlugin"],function(l){var r=function(){l.call(this,"roundProps",-1);this._overwriteProps.length=0},f=r.prototype=new l("roundProps",-1);f.constructor=r;r.API=2;f._onInitTween=function(f,k,b){this._tween=b;return!0};f._onInitAllProps=function(){for(var f=this._tween,k=f.vars.roundProps instanceof
Array?f.vars.roundProps:f.vars.roundProps.split(","),b=k.length,l={},c=f._propLookup.roundProps,a,j,d;-1<--b;)l[k[b]]=1;for(b=k.length;-1<--b;){a=k[b];for(j=f._firstPT;j;)d=j._next,j.pg?j.t._roundProps(l,!0):j.n===a&&(this._add(j.t,a,j.s,j.c),d&&(d._prev=j._prev),j._prev?j._prev._next=d:f._firstPT===j&&(f._firstPT=d),j._next=j._prev=null,f._propLookup[a]=c),j=d}return!1};f._add=function(f,k,b,l){this._addTween(f,k,b,b+l,k,!0);this._overwriteProps.push(k)};l.activate([r]);return r},!0);_gsDefine("easing.Back",
["easing.Ease"],function(l){var r=window.com.greensock._class,f=function(a,b){var c=r("easing."+a,function(){},!0),d=c.prototype=new l;d.constructor=c;d.getRatio=b;return c},n=function(a,b){var c=r("easing."+a,function(a){this._p1=a||0===a?a:1.70158;this._p2=1.525*this._p1},!0),d=c.prototype=new l;d.constructor=c;d.getRatio=b;d.config=function(a){return new c(a)};return c},k=n("BackOut",function(a){return(a-=1)*a*((this._p1+1)*a+this._p1)+1}),b=n("BackIn",function(a){return a*a*((this._p1+1)*a-this._p1)}),
n=n("BackInOut",function(a){return 1>(a*=2)?0.5*a*a*((this._p2+1)*a-this._p2):0.5*((a-=2)*a*((this._p2+1)*a+this._p2)+2)}),s=f("BounceOut",function(a){return a<1/2.75?7.5625*a*a:a<2/2.75?7.5625*(a-=1.5/2.75)*a+0.75:a<2.5/2.75?7.5625*(a-=2.25/2.75)*a+0.9375:7.5625*(a-=2.625/2.75)*a+0.984375}),c=f("BounceIn",function(a){return(a=1-a)<1/2.75?1-7.5625*a*a:a<2/2.75?1-(7.5625*(a-=1.5/2.75)*a+0.75):a<2.5/2.75?1-(7.5625*(a-=2.25/2.75)*a+0.9375):1-(7.5625*(a-=2.625/2.75)*a+0.984375)}),a=f("BounceInOut",function(a){var b=
...
(a-=1))*Math.sin((a-this._p3)*g/this._p2)+1},0.45),w=f("ExpoOut",function(a){return 1-Math.pow(2,-10*a)}),E=f("ExpoIn",function(a){return Math.pow(2,10*(a-1))-0.001}),t=f("ExpoInOut",function(a){return 1>(a*=2)?0.5*Math.pow(2,10*(a-1)):0.5*(2-Math.pow(2,-10*(a-1)))}),D=Math.PI/2,q=f("SineOut",function(a){return Math.sin(a*D)}),U=f("SineIn",function(a){return-Math.cos(a*D)+1}),f=f("SineInOut",function(a){return-0.5*(Math.cos(Math.PI*a)-1)}),G=r("easing.SlowMo",function(a,b,c){null==a?a=0.7:1<a&&(a=
1);this._p=1!=a?b||0===b?b:0.7:0;this._p1=(1-a)/2;this._p2=a;this._p3=this._p1+this._p2;this._calcEnd=!0===c},!0),M=G.prototype=new l;M.constructor=G;M.getRatio=function(a){var b=a+(0.5-a)*this._p;return a<this._p1?this._calcEnd?1-(a=1-a/this._p1)*a:b-(a=1-a/this._p1)*a*a*a*b:a>this._p3?this._calcEnd?1-(a=(a-this._p3)/this._p1)*a:b+(a-b)*(a=(a-this._p3)/this._p1)*a*a*a:this._calcEnd?1:b};G.ease=new G(0.7,0.7);M.config=G.config=function(a,b,c){return new G(a,b,c)};var x=r("easing.SteppedEase",function(a){a=
a||1;this._p1=1/a;this._p2=a+1},!0),M=x.prototype=new l;M.constructor=x;M.getRatio=function(a){0>a?a=0:1<=a&&(a=0.999999999);return(this._p2*a>>0)*this._p1};M.config=x.config=function(a){return new x(a)};r("easing.Bounce",{easeOut:new s,easeIn:new c,easeInOut:new a},!0);r("easing.Circ",{easeOut:new j,easeIn:new d,easeInOut:new z},!0);r("easing.Elastic",{easeOut:new Z,easeIn:new R,easeInOut:new u},!0);r("easing.Expo",{easeOut:new w,easeIn:new E,easeInOut:new t},!0);r("easing.Sine",{easeOut:new q,easeIn:new U,
easeInOut:new f},!0);return{easeOut:new k,easeIn:new b,easeInOut:new n}},!0)});
(function(l){var r=function(a){a=a.split(".");var b=l,c;for(c=0;c<a.length;c++)b[a[c]]=b=b[a[c]]||{};return b},f=r("com.greensock"),n,k,b,s,c,a={},j=function(e,b,c,d){this.sc=a[e]?a[e].sc:[];a[e]=this;this.gsClass=null;this.def=c;var f=b||[],g=[];this.check=function(b){for(var p=f.length,h=0,k;-1<--p;)(k=a[f[p]]||new j(f[p])).gsClass?g[p]=k.gsClass:(h++,b&&k.sc.push(this));if(0===h&&c){b=("com.greensock."+e).split(".");var p=b.pop(),n=r(b.join("."))[p]=this.gsClass=c.apply(c,g);d&&((l.GreenSockGlobals||
l)[p]=n,"function"===typeof define&&define.amd?define((l.GreenSockAMDPath?l.GreenSockAMDPath+"/":"")+e.split(".").join("/"),[],function(){return n}):"undefined"!==typeof module&&module.exports&&(module.exports=n));for(p=0;p<this.sc.length;p++)this.sc[p].check(!1)}};this.check(!0)},d=f._class=function(a,b,c){b=b||function(){};new j(a,[],function(){return b},c);return b};l._gsDefine=function(a,b,c,d){return new j(a,b,c,d)};var z=[0,0,1,1],g=[],u=d("easing.Ease",function(a,b,c,d){this._func=a;this._type=
c||0;this._power=d||0;this._params=b?z.concat(b):z},!0);b=u.prototype;b._calcEnd=!1;b.getRatio=function(a){if(this._func)return this._params[0]=a,this._func.apply(null,this._params);var b=this._type,c=this._power,d=1===b?1-a:2===b?a:0.5>a?2*a:2*(1-a);1===c?d*=d:2===c?d*=d*d:3===c?d*=d*d*d:4===c&&(d*=d*d*d*d);return 1===b?1-d:2===b?d:0.5>a?d/2:1-d/2};n=["Linear","Quad","Cubic","Quart","Quint"];for(k=n.length;-1<--k;)b=d("easing."+n[k],null,!0),s=d("easing.Power"+k,null,!0),b.easeOut=s.easeOut=new u(null,
