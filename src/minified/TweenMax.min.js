 ...
 **/
(window._gsQueue||(window._gsQueue=[])).push(function(){_gsDefine("TweenMax",["core.Animation","core.SimpleTimeline","TweenLite"],function(n,s,f){var l=function(F,c,e){f.call(this,F,c,e);this._cycle=0;this._yoyo=!0===this.vars.yoyo;this._repeat=this.vars.repeat||0;this._repeatDelay=this.vars.repeatDelay||0;this._dirty=!0},k=l.prototype=f.to({},0.1,{}),d=[];l.version=1.651;k.constructor=l;k.kill()._gc=!1;l.killTweensOf=l.killDelayedCallsTo=f.killTweensOf;l.getTweensOf=f.getTweensOf;l.ticker=f.ticker;
...
--d;)c[d]===b&&c.splice(d,1)}return n.prototype._kill.call(this,a)};n.activate([s]);return s},!0);_gsDefine("plugins.CSSPlugin",["plugins.TweenPlugin","TweenLite"],function(n){var s=function(){n.call(this,"css");this._overwriteProps.length=0},f,l,k,d,v={},b=s.prototype=new n("css");b.constructor=s;s.version=1.651;s.API=2;s.defaultTransformPerspective=0;b="px";s.suffixMap={top:b,right:b,bottom:b,left:b,width:b,height:b,fontSize:b,padding:b,margin:b,perspective:b};var a=/(?:\d|\-\d|\.\d|\-\.\d)+/g,
...
"borderBottomLeftRadius"],j=a.style,q,m,e,f,h,i,u,H,n,p,B,r;H=parseFloat(a.offsetWidth);n=parseFloat(a.offsetHeight);g=g.split(" ");for(q=0;q<c.length;q++)this.p.indexOf("border")&&(c[q]=aa(c[q])),f=e=N(a,c[q],k,!1,"0px"),h=m=g[q],i=parseFloat(f),B=f.substr((i+"").length),(r="="===h.charAt(1))?(u=parseInt(h.charAt(0)+"1"),h=h.substr(2),u*=parseFloat(h),p=h.substr((u+"").length-(0>u?1:0))||""):(u=parseFloat(h),p=h.substr((u+"").length)),""===p&&(p=l[b]||B),p!==B&&(f=T(a,"borderLeft",i,B),i=T(a,"borderTop",
i,B),"%"===p?(f=100*(f/H)+"%",e=100*(i/n)+"%"):"em"===p?(B=T(a,"borderLeft",1,"em"),f=f/B+"em",e=i/B+"em"):(f+="px",e=i+"px"),r&&(h=parseFloat(f)+u+p,m=parseFloat(e)+u+p)),d=ea(j,c[q],f+" "+e,h+" "+m,!1,"0px",d);return d},!0,!1,na("0px 0px 0px 0px",!1,!0));L("backgroundPosition","0 0",null,!1,!1,ha);L("backgroundSize","0 0",null,!1,!1,ha);L("perspective","0px",null,!0);L("perspectiveOrigin","50% 50%",null,!0);L("transformStyle","preserve-3d",null,!0);L("margin",null,t("marginTop,marginRight,marginBottom,marginLeft"));
L("padding",null,t("paddingTop,paddingRight,paddingBottom,paddingLeft"));L("clip","rect(0px,0px,0px,0px)");L("textShadow","0px 0px 0px #999",null,!1,!0);L("autoRound",null,function(a,g,b,c,d){return d});L("border","0px solid #000",function(a,g,b,c,d,j){return this.parseComplex(a.style,this.format(N(a,"borderTopWidth",k,!1,"0px")+" "+N(a,"borderTopStyle",k,!1,"solid")+" "+N(a,"borderTopColor",k,!1,"#000")),this.format(g),d,j)},!1,!0,function(a){var g=a.split(" ");return g[0]+" "+(g[1]||"solid")+" "+
(a.match(V)||["#000"])[0]});var xa=function(a){var g=this.t,a=this.s+this.c*a,b;100===a&&(g.removeAttribute("filter"),b=!N(this.data,"filter"));b||(this.xn1&&(g.filter=g.filter||"alpha(opacity=100)"),g.filter=-1===g.filter.indexOf("opacity")?g.filter+(" alpha(opacity="+(a>>0)+")"):g.filter.replace(J,"opacity="+(a>>0)))};L("opacity,alpha,autoAlpha","1",function(a,g,b,c,d,j){var e=parseFloat(N(a,"opacity",k,!1,"1")),g=parseFloat(g),m=a.style,f;"autoAlpha"===b&&(f=N(a,"visibility",k),1===e&&"hidden"===
f&&(e=0),d=new O(m,"visibility",0,0,d,-1,null,!1,0,0!==e?"visible":"hidden",0===g?"hidden":"visible"),d.xs0="visible",c._overwriteProps.push(d.n));q?d=new O(m,"opacity",e,g-e,d):(d=new O(m,"opacity",100*e,100*(g-e),d),d.xn1="autoAlpha"===b?1:0,m.zoom=1,d.type=2,d.b="alpha(opacity="+d.s+")",d.e="alpha(opacity="+(d.s+d.c)+")",d.data=a,d.plugin=j,d.setRatio=xa);return d});var ya=function(a){if(1===a||0===a){this.t.className=1===a?this.e:this.b;for(var a=this.data,g=this.t.style,b=g.removeProperty?"removeProperty":
"removeAttribute";a;){if(a.v)g[a.p]=a.v;else g[b](a.p.replace(G,"-$1").toLowerCase());a=a._next}}else this.t.className!==this.b&&(this.t.className=this.b)};L("className",null,function(a,g,b,c,d,j,q){var e=a.className,m=a.style.cssText,d=c._classNamePT=new O(a,b,0,0,d,2);d.setRatio=ya;d.b=e;d.e="="!==g.charAt(1)?g:"+"===g.charAt(0)?e+" "+g.substr(2):e.split(g.substr(2)).join("");c._tween._duration&&(g=da(a,k,!0),a.className=d.e,q=la(a,g,da(a),q),a.className=e,d.data=q.firstMPT,a.style.cssText=m,d=
d.xfirst=c.parse(a,q.difs,d,j));return d});b=["bezier","throwProps","physicsProps","physics2D"];for(R=b.length;R--;)x(b[R]);b=s.prototype;b._firstPT=null;b._onInitTween=function(a,g,b){if(!a.nodeType)return!1;this._target=a;this._tween=b;D=g.autoRound;f=!1;l=g.suffixMap||s.suffixMap;k=ca(a,"");d=this._overwriteProps;var b=a.style,c,j,e;if(A&&""===b.zIndex&&(c=N(a,"zIndex",k),"auto"===c||""===c))b.zIndex=0;"string"===typeof g&&(j=b.cssText,c=da(a,k),b.cssText=j+";"+g,c=la(a,c,da(a)).difs,!q&&X.test(g)&&
(c.opacity=parseFloat(RegExp.$1)),g=c,b.cssText=j);this._firstPT=a=this.parse(a,g,null);if(f){for(;a;){b=a._next;for(g=j;g&&g.pr>a.pr;)g=g._next;(a._prev=g?g._prev:e)?a._prev._next=a:j=a;(a._next=g)?g._prev=a:e=a;a=b}this._firstPT=j}return!0};b.parse=function(a,g,b,c){var d=a.style,j,q,e,m,f,h,i,u;for(j in g){f=g[j];if(q=v[j])b=q.parse(a,f,j,this,b,c,g);else if(q=N(a,j,k)+"",i="string"===typeof f,"color"===j||"fill"===j||"stroke"===j||-1!==j.indexOf("Color")||i&&!f.indexOf("rgb"))i||(f=ja(f),f=(3<
f.length?"rgba(":"rgb(")+f.join(",")+")"),b=ea(d,j,q,f,!0,"transparent",b,0,c);else if(i&&(-1!==f.indexOf(" ")||-1!==f.indexOf(",")))b=ea(d,j,q,f,!0,null,b,0,c);else{e=parseFloat(q);h=q.substr((e+"").length);if(""===q||"auto"===q)if("width"===j||"height"===j){e=a;u=j;m=k;h=parseFloat("width"===u?e.offsetWidth:e.offsetHeight);u=ra[u];var H=u.length;for(m=m||ca(e,null);-1<--H;)h-=parseFloat(N(e,"padding"+u[H],m,!0))||0,h-=parseFloat(N(e,"border"+u[H]+"Width",m,!0))||0;e=h;h="px"}else e="opacity"!==
j?0:1,h="";(u=i&&"="===f.charAt(1))?(m=parseInt(f.charAt(0)+"1"),f=f.substr(2),m*=parseFloat(f),i=f.substr((m+"").length-(0>m?1:0))||""):(m=parseFloat(f),i=i?f.substr((m+"").length)||"":"");""===i&&(i=l[j]||h);f=m||0===m?(u?m+e:m)+i:g[j];if(h!==i&&""!==i&&(m||0===m))if(e||0===e)if(e=T(a,j,e,h),"%"===i?(e/=T(a,j,100,"%")/100,100<e&&(e=100)):"em"===i?e/=T(a,j,1,"em"):(m=T(a,j,m,i),i="px"),u&&(m||0===m))f=m+e+i;u&&(m+=e);(e||0===e)&&(m||0===m)?(b=new O(d,j,e,m-e,b,0,"css_"+j,!1!==D&&("px"===i||"zIndex"===
j),0,q,f),b.xs0=i):(b=new O(d,j,m||e||0,0,b,-1,"css_"+j,!1,0,q,f),b.xs0="display"===j&&"none"===f?q:f)}c&&(b&&!b.plugin)&&(b.plugin=c)}return b};b.setRatio=function(a){var g=this._firstPT,b,c;if(1===a&&(this._tween._time===this._tween._duration||0===this._tween._time))for(;g;)2!==g.type?g.t[g.p]=g.e:g.setRatio(a),g=g._next;else if(a||!(this._tween._time===this._tween._duration||0===this._tween._time)||-1E-6===this._tween._rawPrevTime)for(;g;){b=g.c*a+g.s;g.r?b=0<b?b+0.5>>0:b-0.5>>0:1E-6>b&&-1E-6<
b&&(b=0);if(g.type)if(1===g.type)if(c=g.l,2===c)g.t[g.p]=g.xs0+b+g.xs1+g.xn1+g.xs2;else if(3===c)g.t[g.p]=g.xs0+b+g.xs1+g.xn1+g.xs2+g.xn2+g.xs3;else if(4===c)g.t[g.p]=g.xs0+b+g.xs1+g.xn1+g.xs2+g.xn2+g.xs3+g.xn3+g.xs4;else if(5===c)g.t[g.p]=g.xs0+b+g.xs1+g.xn1+g.xs2+g.xn2+g.xs3+g.xn3+g.xs4+g.xn4+g.xs5;else{b=g.xs0+b+g.xs1;for(c=1;c<g.l;c++)b+=g["xn"+c]+g["xs"+(c+1)];g.t[g.p]=b}else-1===g.type?g.t[g.p]=g.xs0:g.setRatio&&g.setRatio(a);else g.t[g.p]=b+g.xs0;g=g._next}else for(;g;)2!==g.type?g.t[g.p]=
g.b:g.setRatio(a),g=g._next};b._linkCSSP=function(a,g,b){a&&(g&&(g._prev=a),a._next&&(a._next._prev=a._prev),b&&(b._next=a),a._prev?a._prev._next=a._next:this._firstPT===a&&(this._firstPT=a._next),a._next=g,a._prev=b);return a};b._kill=function(a){var g=a,b=!1,c,d;if(a.css_autoAlpha||a.css_alpha){g={};for(d in a)g[d]=a[d];g.css_opacity=1;g.css_autoAlpha&&(g.css_visibility=1)}if(a.css_className&&(c=this._classNamePT))(a=c.xfirst)&&a._prev?this._linkCSSP(a._prev,c._next,a._prev._prev):a===this._firstPT&&
(this._firstPT=null),c._next&&this._linkCSSP(c._next,c._next._next,a._prev),this._target._gsOverwrittenClassNamePT=this._linkCSSP(c,this._target._gsOverwrittenClassNamePT),this._classNamePT=null,b=!0;return n.prototype._kill.call(this,g)||b};n.activate([s]);return s},!0);_gsDefine("plugins.RoundPropsPlugin",["plugins.TweenPlugin"],function(n){var s=function(){n.call(this,"roundProps",-1);this._overwriteProps.length=0},f=s.prototype=new n("roundProps",-1);f.constructor=s;s.API=2;f._onInitTween=function(f,
k,d){this._tween=d;return!0};f._onInitAllProps=function(){for(var f=this._tween,k=f.vars.roundProps instanceof Array?f.vars.roundProps:f.vars.roundProps.split(","),d=k.length,n={},b=f._propLookup.roundProps,a,s,c;-1<--d;)n[k[d]]=1;for(d=k.length;-1<--d;){a=k[d];for(s=f._firstPT;s;)c=s._next,s.pg?s.t._roundProps(n,!0):s.n===a&&(this._add(s.t,a,s.s,s.c),c&&(c._prev=s._prev),s._prev?s._prev._next=c:f._firstPT===s&&(f._firstPT=c),s._next=s._prev=null,f._propLookup[a]=b),s=c}return!1};f._add=function(f,
k,d,n){this._addTween(f,k,d,d+n,k,!0);this._overwriteProps.push(k)};n.activate([s]);return s},!0);_gsDefine("easing.Back",["easing.Ease"],function(n){var s=window.com.greensock._class,f=function(a,b){var c=s("easing."+a,function(){},!0),d=c.prototype=new n;d.constructor=c;d.getRatio=b;return c},l=function(a,b){var c=s("easing."+a,function(a){this._p1=a||0===a?a:1.70158;this._p2=1.525*this._p1},!0),d=c.prototype=new n;d.constructor=c;d.getRatio=b;d.config=function(a){return new c(a)};return c},k=l("BackOut",
function(a){return(a-=1)*a*((this._p1+1)*a+this._p1)+1}),d=l("BackIn",function(a){return a*a*((this._p1+1)*a-this._p1)}),l=l("BackInOut",function(a){return 1>(a*=2)?0.5*a*a*((this._p2+1)*a-this._p2):0.5*((a-=2)*a*((this._p2+1)*a+this._p2)+2)}),v=f("BounceOut",function(a){return a<1/2.75?7.5625*a*a:a<2/2.75?7.5625*(a-=1.5/2.75)*a+0.75:a<2.5/2.75?7.5625*(a-=2.25/2.75)*a+0.9375:7.5625*(a-=2.625/2.75)*a+0.984375}),b=f("BounceIn",function(a){return(a=1-a)<1/2.75?1-7.5625*a*a:a<2/2.75?1-(7.5625*(a-=1.5/
2.75)*a+0.75):a<2.5/2.75?1-(7.5625*(a-=2.25/2.75)*a+0.9375):1-(7.5625*(a-=2.625/2.75)*a+0.984375)}),a=f("BounceInOut",function(a){var b=0.5>a,a=b?1-2*a:2*a-1,a=a<1/2.75?7.5625*a*a:a<2/2.75?7.5625*(a-=1.5/2.75)*a+0.75:a<2.5/2.75?7.5625*(a-=2.25/2.75)*a+0.9375:7.5625*(a-=2.625/2.75)*a+0.984375;return b?0.5*(1-a):0.5*a+0.5}),F=f("CircOut",function(a){return Math.sqrt(1-(a-=1)*a)}),c=f("CircIn",function(a){return-(Math.sqrt(1-a*a)-1)}),e=f("CircInOut",function(a){return 1>(a*=2)?-0.5*(Math.sqrt(1-a*a)-
1):0.5*(Math.sqrt(1-(a-=2)*a)+1)}),i=2*Math.PI,J=function(a,b,c){var d=s("easing."+a,function(a,b){this._p1=a||1;this._p2=b||c;this._p3=this._p2/i*(Math.asin(1/this._p1)||0)},!0),a=d.prototype=new n;a.constructor=d;a.getRatio=b;a.config=function(a,b){return new d(a,b)};return d},X=J("ElasticOut",function(a){return this._p1*Math.pow(2,-10*a)*Math.sin((a-this._p3)*i/this._p2)+1},0.3),G=J("ElasticIn",function(a){return-(this._p1*Math.pow(2,10*(a-=1))*Math.sin((a-this._p3)*i/this._p2))},0.3),J=J("ElasticInOut",
function(a){return 1>(a*=2)?-0.5*this._p1*Math.pow(2,10*(a-=1))*Math.sin((a-this._p3)*i/this._p2):0.5*this._p1*Math.pow(2,-10*(a-=1))*Math.sin((a-this._p3)*i/this._p2)+1},0.45),h=f("ExpoOut",function(a){return 1-Math.pow(2,-10*a)}),w=f("ExpoIn",function(a){return Math.pow(2,10*(a-1))-0.001}),p=f("ExpoInOut",function(a){return 1>(a*=2)?0.5*Math.pow(2,10*(a-1)):0.5*(2-Math.pow(2,-10*(a-1)))}),C=Math.PI/2,r=f("SineOut",function(a){return Math.sin(a*C)}),P=f("SineIn",function(a){return-Math.cos(a*C)+
1}),f=f("SineInOut",function(a){return-0.5*(Math.cos(Math.PI*a)-1)}),I=s("easing.SlowMo",function(a,b,c){null==a?a=0.7:1<a&&(a=1);this._p=1!=a?b||0===b?b:0.7:0;this._p1=(1-a)/2;this._p2=a;this._p3=this._p1+this._p2;this._calcEnd=!0===c},!0),E=I.prototype=new n;E.constructor=I;E.getRatio=function(a){var b=a+(0.5-a)*this._p;return a<this._p1?this._calcEnd?1-(a=1-a/this._p1)*a:b-(a=1-a/this._p1)*a*a*a*b:a>this._p3?this._calcEnd?1-(a=(a-this._p3)/this._p1)*a:b+(a-b)*(a=(a-this._p3)/this._p1)*a*a*a:this._calcEnd?
1:b};I.ease=new I(0.7,0.7);E.config=I.config=function(a,b,c){return new I(a,b,c)};var y=s("easing.SteppedEase",function(a){a=a||1;this._p1=1/a;this._p2=a+1},!0),E=y.prototype=new n;E.constructor=y;E.getRatio=function(a){0>a?a=0:1<=a&&(a=0.999999999);return(this._p2*a>>0)*this._p1};E.config=y.config=function(a){return new y(a)};s("easing.Bounce",{easeOut:new v,easeIn:new b,easeInOut:new a},!0);s("easing.Circ",{easeOut:new F,easeIn:new c,easeInOut:new e},!0);s("easing.Elastic",{easeOut:new X,easeIn:new G,
easeInOut:new J},!0);s("easing.Expo",{easeOut:new h,easeIn:new w,easeInOut:new p},!0);s("easing.Sine",{easeOut:new r,easeIn:new P,easeInOut:new f},!0);return{easeOut:new k,easeIn:new d,easeInOut:new l}},!0)});
